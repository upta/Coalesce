        ...
        if (Proxy) {
            return new Proxy(instance, {
                apply: function(target, thisArg, argArray) {
                    return target.invoke.apply(thisArg, argArray)
                }
            }) as any
        }
...
abstract class ApiState<TCall extends (this: null, ...args: any[]) => ApiResultPromise<T>, T extends Model<ClassType>> {
    ...
    */
    ...
    constructor(
        ...
        this.invoke = function invoke() {
            return _this._invokeInternal.apply(_this, arguments);
        } as TCall
    }
}
